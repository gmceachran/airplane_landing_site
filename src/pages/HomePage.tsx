    ...
    <div className="relative min-h-screen text-foreground">
        ...
        <section className="mx-auto flex max-w-5xl flex-col gap-10 px-4 pb-24 pt-16 sm:px-6 sm:pt-24">
          <div className="max-w-3xl space-y-6">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-sky-800">
              Aviation parts · Warehouse inventory · Teardown bids
            </p>
            ...
            <p className="max-w-2xl text-lg leading-relaxed text-slate-700 sm:text-xl">
              Roswell Aerospace offers a substantial warehouse inventory and
              competitive teardown services, working directly with operators,
              MROs, and resellers who need depth, consistency, and a direct
              line to the owner.
            </p>
            <div className="flex flex-wrap gap-3">
              <Button asChild size="lg" className="rounded-full px-6">
                <a href="#contact">Request a teardown bid</a>
              </Button>
              <Button
                asChild
                size="lg"
            ...
            {[
              {
                ...
                body: "Thousands of line items suit high-volume programs, rotables, and hard-to-find legacy stock.",
              },
              {
                title: "Teardown bids",
                body: "We bid competitively on aircraft teardowns and part-outs, handling recovery, documentation, and resale.",
              },
              {
            ...
            <div className="grid gap-8 md:grid-cols-2 md:gap-12">
              <div className="space-y-4 text-slate-700">
                <p className="leading-relaxed">
                  Whether you are filling a critical AOG gap, building
                  long-cycle stock, or parting out an airframe, we operate
                  as a dependable secondary source. Documentation and
                  traceability are handled with the seriousness buyers expect.
                </p>
                <p className="leading-relaxed text-slate-600">
                  If you represent an airline, MRO, distributor, or specialty
                  broker — or you have an aircraft ready for teardown and want
                  a bid — introduce yourself and we will respond directly.
                </p>
              </div>
              <EmailLeadForm />
            </div>
      ...
      <footer className="border-t border-sky-200/70 bg-white/50 py-10 text-center text-sm text-slate-600 backdrop-blur-md">
        <p>
          ...
          warehouse disposition · Teardown bids
        </p>
      </footer>
    </div>
  );
